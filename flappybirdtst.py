...
startgm_img = pygame.image.load('message.png')
...
while run:
    ...
    draw_text(str(score), font, white, int(screen_width / 2.2), 10)
    ...
    if game_over == True:
        screen.blit(game_over_img, (int(screen_width / 4 - 20), int(screen_height / 4)))
